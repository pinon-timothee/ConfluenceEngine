...
/**
 * Base class that represents a row from the 'website_zone' table.
 *
 *
 *
 * @package    propel.generator.src.CE.Model.Base
 */
abstract class WebsiteZone implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CE\\Model\\Map\\WebsiteZoneTableMap';
    ...
    /**
     * Initializes internal state of CE\Model\Base\WebsiteZone object.
     */
    ...
    /**
     * Compares this with another <code>WebsiteZone</code> instance.  If
     * <code>obj</code> is an instance of <code>WebsiteZone</code>, delegates to
     * <code>equals(WebsiteZone)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|WebsiteZone The current object, for fluid interface
     */
     ...
     * @return $this|\CE\Model\WebsiteZone The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[WebsiteZoneTableMap::COL_ID] = true;
        }
    ...
    public function setWebsiteId($v)
    {
        ...
        if ($this->website_id !== $v) {
            $this->website_id = $v;
            $this->modifiedColumns[WebsiteZoneTableMap::COL_WEBSITE_ID] = true;
        }
    ...
    public function setZone($v)
    {
        ...
        if ($this->zone !== $v) {
            $this->zone = $v;
            $this->modifiedColumns[WebsiteZoneTableMap::COL_ZONE] = true;
        }
    ...
    public function setWebsiteRoutingId($v)
    {
        ...
        if ($this->website_routing_id !== $v) {
            ...
            $this->modifiedColumns[WebsiteZoneTableMap::COL_WEBSITE_ROUTING_ID] = true;
        }
    ...
    public function setClass($v)
    {
        ...
        if ($this->class !== $v) {
            $this->class = $v;
            $this->modifiedColumns[WebsiteZoneTableMap::COL_CLASS] = true;
        }
    ...
    public function setBlock($v)
    {
        ...
        if ($this->block !== $v) {
            $this->block = $v;
            $this->modifiedColumns[WebsiteZoneTableMap::COL_BLOCK] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : WebsiteZoneTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : WebsiteZoneTableMap::translateFieldName('WebsiteId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->website_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : WebsiteZoneTableMap::translateFieldName('Zone', TableMap::TYPE_PHPNAME, $indexType)];
            $this->zone = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : WebsiteZoneTableMap::translateFieldName('WebsiteRoutingId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->website_routing_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : WebsiteZoneTableMap::translateFieldName('Class', TableMap::TYPE_PHPNAME, $indexType)];
            $this->class = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : WebsiteZoneTableMap::translateFieldName('Block', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 6; // 6 = WebsiteZoneTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CE\\Model\\WebsiteZone'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildWebsiteZoneQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see WebsiteZone::setDeleted()
     * @see WebsiteZone::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildWebsiteZoneQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                WebsiteZoneTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[WebsiteZoneTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . WebsiteZoneTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(WebsiteZoneTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(WebsiteZoneTableMap::COL_WEBSITE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`website_id`';
        }
        if ($this->isColumnModified(WebsiteZoneTableMap::COL_ZONE)) {
            $modifiedColumns[':p' . $index++]  = '`zone`';
        }
        if ($this->isColumnModified(WebsiteZoneTableMap::COL_WEBSITE_ROUTING_ID)) {
            $modifiedColumns[':p' . $index++]  = '`website_routing_id`';
        }
        if ($this->isColumnModified(WebsiteZoneTableMap::COL_CLASS)) {
            $modifiedColumns[':p' . $index++]  = '`class`';
        }
        if ($this->isColumnModified(WebsiteZoneTableMap::COL_BLOCK)) {
            $modifiedColumns[':p' . $index++]  = '`block`';
        }

        $sql = sprintf(
            'INSERT INTO `website_zone` (%s) VALUES (%s)',
    ...
    {
        $pos = WebsiteZoneTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['WebsiteZone'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['WebsiteZone'][$this->hashCode()] = true;
        $keys = WebsiteZoneTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getWebsiteId(),
            $keys[2] => $this->getZone(),
            $keys[3] => $this->getWebsiteRoutingId(),
            $keys[4] => $this->getClass(),
            $keys[5] => $this->getBlock(),
        );
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\CE\Model\WebsiteZone
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setZone($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setWebsiteRoutingId($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setClass($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setBlock($arr[$keys[5]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CE\Model\WebsiteZone The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(WebsiteZoneTableMap::DATABASE_NAME);

        if ($this->isColumnModified(WebsiteZoneTableMap::COL_ID)) {
            $criteria->add(WebsiteZoneTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(WebsiteZoneTableMap::COL_WEBSITE_ID)) {
            $criteria->add(WebsiteZoneTableMap::COL_WEBSITE_ID, $this->website_id);
        }
        if ($this->isColumnModified(WebsiteZoneTableMap::COL_ZONE)) {
            $criteria->add(WebsiteZoneTableMap::COL_ZONE, $this->zone);
        }
        if ($this->isColumnModified(WebsiteZoneTableMap::COL_WEBSITE_ROUTING_ID)) {
            $criteria->add(WebsiteZoneTableMap::COL_WEBSITE_ROUTING_ID, $this->website_routing_id);
        }
        if ($this->isColumnModified(WebsiteZoneTableMap::COL_CLASS)) {
            $criteria->add(WebsiteZoneTableMap::COL_CLASS, $this->class);
        }
        if ($this->isColumnModified(WebsiteZoneTableMap::COL_BLOCK)) {
            $criteria->add(WebsiteZoneTableMap::COL_BLOCK, $this->block);
        }
    ...
    {
        $criteria = ChildWebsiteZoneQuery::create();
        $criteria->add(WebsiteZoneTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CE\Model\WebsiteZone (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CE\Model\WebsiteZone Clone of current object.
     * @throws PropelException
     */
    ...
    public function getWebsite(ConnectionInterface $con = null)
    {
        if ($this->aWebsite === null && ($this->website_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aWebsite->addWebsiteZones($this);
             */
        }
    ...
    public function getWebsiteRouting(ConnectionInterface $con = null)
    {
        if ($this->aWebsiteRouting === null && ($this->website_routing_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aWebsiteRouting->addWebsiteZones($this);
             */
        }
    ...
    {
        if (null !== $this->aWebsite) {
            $this->aWebsite->removeWebsiteZone($this);
        }
        if (null !== $this->aWebsiteRouting) {
            $this->aWebsiteRouting->removeWebsiteZone($this);
        }
        $this->id = null;
    ...
    {
        return (string) $this->exportTo(WebsiteZoneTableMap::DEFAULT_STRING_FORMAT);
    }
