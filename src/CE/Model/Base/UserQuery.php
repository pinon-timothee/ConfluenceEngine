 ...
 * @method     ChildUserQuery orderByCulture($order = Criteria::ASC) Order by the culture column
 * @method     ChildUserQuery orderByAvatar($order = Criteria::ASC) Order by the avatar column
 * @method     ChildUserQuery orderByLastLoginAt($order = Criteria::ASC) Order by the last_login_at column
 *
 ...
 * @method     ChildUserQuery groupByCulture() Group by the culture column
 * @method     ChildUserQuery groupByAvatar() Group by the avatar column
 * @method     ChildUserQuery groupByLastLoginAt() Group by the last_login_at column
 *
 ...
 *
 * @method     ChildUserQuery leftJoinUserWebsite($relationAlias = null) Adds a LEFT JOIN clause to the query using the UserWebsite relation
 * @method     ChildUserQuery rightJoinUserWebsite($relationAlias = null) Adds a RIGHT JOIN clause to the query using the UserWebsite relation
 * @method     ChildUserQuery innerJoinUserWebsite($relationAlias = null) Adds a INNER JOIN clause to the query using the UserWebsite relation
 *
 * @method     ChildUserQuery joinWithUserWebsite($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the UserWebsite relation
 *
 * @method     ChildUserQuery leftJoinWithUserWebsite() Adds a LEFT JOIN clause and with to the query using the UserWebsite relation
 * @method     ChildUserQuery rightJoinWithUserWebsite() Adds a RIGHT JOIN clause and with to the query using the UserWebsite relation
 * @method     ChildUserQuery innerJoinWithUserWebsite() Adds a INNER JOIN clause and with to the query using the UserWebsite relation
 *
 * @method     \CE\Model\AccountQuery|\CE\Model\UserWebsiteQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildUser findOneByCulture(string $culture) Return the first ChildUser filtered by the culture column
 * @method     ChildUser findOneByAvatar(string $avatar) Return the first ChildUser filtered by the avatar column
 * @method     ChildUser findOneByLastLoginAt(string $last_login_at) Return the first ChildUser filtered by the last_login_at column *
 ...
 * @method     ChildUser requireOneByCulture(string $culture) Return the first ChildUser filtered by the culture column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildUser requireOneByLastLoginAt(string $last_login_at) Return the first ChildUser filtered by the last_login_at column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildUser[]|ObjectCollection findByCulture(string $culture) Return ChildUser objects filtered by the culture column
 * @method     ChildUser[]|ObjectCollection findByAvatar(string $avatar) Return ChildUser objects filtered by the avatar column
 * @method     ChildUser[]|ObjectCollection findByLastLoginAt(string $last_login_at) Return ChildUser objects filtered by the last_login_at column
...
abstract class UserQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \CE\Model\Base\UserQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\CE\\Model\\User', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `id`, `account_id`, `username`, `password`, `roles`, `email`, `lastname`, `firstname`, `culture`, `avatar`, `last_login_at` FROM `user` WHERE `id` = :p0';
        try {
    ...
    public function filterByCulture($culture = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(UserTableMap::COL_CULTURE, $culture, $comparison);
    }
    ...
    public function filterByLastLoginAt($lastLoginAt = null, $comparison = null)
    {
        if (is_array($lastLoginAt)) {
            ...
            if (isset($lastLoginAt['min'])) {
                $this->addUsingAlias(UserTableMap::COL_LAST_LOGIN_AT, $lastLoginAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($lastLoginAt['max'])) {
                $this->addUsingAlias(UserTableMap::COL_LAST_LOGIN_AT, $lastLoginAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(UserTableMap::COL_LAST_LOGIN_AT, $lastLoginAt, $comparison);
    }
    ...
    public function filterByUserWebsite($userWebsite, $comparison = null)
    {
        if ($userWebsite instanceof \CE\Model\UserWebsite) {
            return $this
                ->addUsingAlias(UserTableMap::COL_ID, $userWebsite->getUserId(), $comparison);
