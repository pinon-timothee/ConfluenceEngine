...
/**
 * Base class that represents a row from the 'website_redirection' table.
 *
 *
 *
 * @package    propel.generator.src.CE.Model.Base
 */
abstract class WebsiteRedirection implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CE\\Model\\Map\\WebsiteRedirectionTableMap';
    ...
    /**
     * Initializes internal state of CE\Model\Base\WebsiteRedirection object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>WebsiteRedirection</code> instance.  If
     * <code>obj</code> is an instance of <code>WebsiteRedirection</code>, delegates to
     * <code>equals(WebsiteRedirection)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|WebsiteRedirection The current object, for fluid interface
     */
     ...
     * @return $this|\CE\Model\WebsiteRedirection The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[WebsiteRedirectionTableMap::COL_ID] = true;
        }
    ...
    public function setWebsiteId($v)
    {
        ...
        if ($this->website_id !== $v) {
            $this->website_id = $v;
            $this->modifiedColumns[WebsiteRedirectionTableMap::COL_WEBSITE_ID] = true;
        }
    ...
    public function setPath($v)
    {
        ...
        if ($this->path !== $v) {
            $this->path = $v;
            $this->modifiedColumns[WebsiteRedirectionTableMap::COL_PATH] = true;
        }
    ...
    public function setWebsiteRoutingId($v)
    {
        ...
        if ($this->website_routing_id !== $v) {
            ...
            $this->modifiedColumns[WebsiteRedirectionTableMap::COL_WEBSITE_ROUTING_ID] = true;
        }
    ...
    public function setCulture($v)
    {
        ...
        if ($this->culture !== $v) {
            $this->culture = $v;
            $this->modifiedColumns[WebsiteRedirectionTableMap::COL_CULTURE] = true;
        }
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[WebsiteRedirectionTableMap::COL_CODE] = true;
        }
    ...
    public function setEnable($v)
    {
        ...
        if ($this->enable !== $v) {
            $this->enable = $v;
            $this->modifiedColumns[WebsiteRedirectionTableMap::COL_ENABLE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : WebsiteRedirectionTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : WebsiteRedirectionTableMap::translateFieldName('WebsiteId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->website_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : WebsiteRedirectionTableMap::translateFieldName('Path', TableMap::TYPE_PHPNAME, $indexType)];
            $this->path = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : WebsiteRedirectionTableMap::translateFieldName('WebsiteRoutingId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->website_routing_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : WebsiteRedirectionTableMap::translateFieldName('Culture', TableMap::TYPE_PHPNAME, $indexType)];
            $this->culture = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : WebsiteRedirectionTableMap::translateFieldName('Code', TableMap::TYPE_PHPNAME, $indexType)];
            $this->code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : WebsiteRedirectionTableMap::translateFieldName('Enable', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 7; // 7 = WebsiteRedirectionTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CE\\Model\\WebsiteRedirection'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildWebsiteRedirectionQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see WebsiteRedirection::setDeleted()
     * @see WebsiteRedirection::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildWebsiteRedirectionQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                WebsiteRedirectionTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(WebsiteRedirectionTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(WebsiteRedirectionTableMap::COL_WEBSITE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`website_id`';
        }
        if ($this->isColumnModified(WebsiteRedirectionTableMap::COL_PATH)) {
            $modifiedColumns[':p' . $index++]  = '`path`';
        }
        if ($this->isColumnModified(WebsiteRedirectionTableMap::COL_WEBSITE_ROUTING_ID)) {
            $modifiedColumns[':p' . $index++]  = '`website_routing_id`';
        }
        if ($this->isColumnModified(WebsiteRedirectionTableMap::COL_CULTURE)) {
            $modifiedColumns[':p' . $index++]  = '`culture`';
        }
        if ($this->isColumnModified(WebsiteRedirectionTableMap::COL_CODE)) {
            $modifiedColumns[':p' . $index++]  = '`code`';
        }
        if ($this->isColumnModified(WebsiteRedirectionTableMap::COL_ENABLE)) {
            $modifiedColumns[':p' . $index++]  = '`enable`';
        }

        $sql = sprintf(
            'INSERT INTO `website_redirection` (%s) VALUES (%s)',
    ...
    {
        $pos = WebsiteRedirectionTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['WebsiteRedirection'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['WebsiteRedirection'][$this->hashCode()] = true;
        $keys = WebsiteRedirectionTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getWebsiteId(),
            $keys[2] => $this->getPath(),
            $keys[3] => $this->getWebsiteRoutingId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\CE\Model\WebsiteRedirection
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) {
            $this->setWebsiteRoutingId($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setCulture($arr[$keys[4]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CE\Model\WebsiteRedirection The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(WebsiteRedirectionTableMap::COL_ID)) {
            $criteria->add(WebsiteRedirectionTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(WebsiteRedirectionTableMap::COL_WEBSITE_ID)) {
            $criteria->add(WebsiteRedirectionTableMap::COL_WEBSITE_ID, $this->website_id);
        }
        if ($this->isColumnModified(WebsiteRedirectionTableMap::COL_PATH)) {
            $criteria->add(WebsiteRedirectionTableMap::COL_PATH, $this->path);
        }
        if ($this->isColumnModified(WebsiteRedirectionTableMap::COL_WEBSITE_ROUTING_ID)) {
            $criteria->add(WebsiteRedirectionTableMap::COL_WEBSITE_ROUTING_ID, $this->website_routing_id);
        }
        if ($this->isColumnModified(WebsiteRedirectionTableMap::COL_CULTURE)) {
            $criteria->add(WebsiteRedirectionTableMap::COL_CULTURE, $this->culture);
        }
        if ($this->isColumnModified(WebsiteRedirectionTableMap::COL_CODE)) {
            $criteria->add(WebsiteRedirectionTableMap::COL_CODE, $this->code);
        }
        if ($this->isColumnModified(WebsiteRedirectionTableMap::COL_ENABLE)) {
            $criteria->add(WebsiteRedirectionTableMap::COL_ENABLE, $this->enable);
        }
    ...
    {
        $criteria = ChildWebsiteRedirectionQuery::create();
        $criteria->add(WebsiteRedirectionTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CE\Model\WebsiteRedirection (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CE\Model\WebsiteRedirection Clone of current object.
     * @throws PropelException
     */
    ...
    public function getWebsite(ConnectionInterface $con = null)
    {
        if ($this->aWebsite === null && ($this->website_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aWebsite->addWebsiteRedirections($this);
             */
        }
    ...
    public function getWebsiteRouting(ConnectionInterface $con = null)
    {
        if ($this->aWebsiteRouting === null && ($this->website_routing_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aWebsiteRouting->addWebsiteRedirections($this);
             */
        }
    ...
    {
        if (null !== $this->aWebsite) {
            $this->aWebsite->removeWebsiteRedirection($this);
        }
        if (null !== $this->aWebsiteRouting) {
            $this->aWebsiteRouting->removeWebsiteRedirection($this);
        }
        $this->id = null;
    ...
    {
        return (string) $this->exportTo(WebsiteRedirectionTableMap::DEFAULT_STRING_FORMAT);
    }
