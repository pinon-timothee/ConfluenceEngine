...
abstract class Currency implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\CE\\Model\\Map\\CurrencyTableMap';
    ...
    /**
     * Initializes internal state of CE\Model\Base\Currency object.
     */
     ...
     * @return $this|\CE\Model\Currency The current object (for fluent API support)
     */
    ...
    public function setCountries($v)
    {
        ...
        if ($this->countries !== $v) {
            $this->countries = $v;
            $this->modifiedColumns[CurrencyTableMap::COL_COUNTRIES] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CurrencyTableMap::translateFieldName('Countries', TableMap::TYPE_PHPNAME, $indexType)];
            $this->countries = (null !== $col) ? (string) $col : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = CurrencyTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CE\\Model\\Currency'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CurrencyTableMap::COL_COUNTRIES)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`code`':
                        ...
                        break;
                    case '`countries`':
                        $stmt->bindValue($identifier, $this->countries, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CE\Model\Currency The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CurrencyTableMap::COL_COUNTRIES)) {
            $criteria->add(CurrencyTableMap::COL_COUNTRIES, $this->countries);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CE\Model\Currency (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CE\Model\Currency Clone of current object.
     * @throws PropelException
     */
