 ...
 */
abstract class Culture implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CE\\Model\\Map\\CultureTableMap';
    ...
    /**
     * Initializes internal state of CE\Model\Base\Culture object.
     */
    ...
    /**
     * Compares this with another <code>Culture</code> instance.  If
     * <code>obj</code> is an instance of <code>Culture</code>, delegates to
     * <code>equals(Culture)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Culture The current object, for fluid interface
     */
     ...
     * @return $this|\CE\Model\Culture The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[CultureTableMap::COL_ID] = true;
        }
    ...
    public function setCulture($v)
    {
        ...
        if ($this->culture !== $v) {
            $this->culture = $v;
            $this->modifiedColumns[CultureTableMap::COL_CULTURE] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[CultureTableMap::COL_NAME] = true;
        }
    ...
    /**
     * Set the value of [guess] column.
     *
     * @param string $v new value
     * @return $this|\CE\Model\Culture The current object (for fluent API support)
     */
    public function setGuess($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->guess !== $v) {
            $this->guess = $v;
            $this->modifiedColumns[CultureTableMap::COL_GUESS] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CultureTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CultureTableMap::translateFieldName('Culture', TableMap::TYPE_PHPNAME, $indexType)];
            $this->culture = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CultureTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CultureTableMap::translateFieldName('Guess', TableMap::TYPE_PHPNAME, $indexType)];
            $this->guess = (null !== $col) ? (string) $col : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = CultureTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CE\\Model\\Culture'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCultureQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Culture::setDeleted()
     * @see Culture::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCultureQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CultureTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CultureTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CultureTableMap::COL_CULTURE)) {
            $modifiedColumns[':p' . $index++]  = '`culture`';
        }
        if ($this->isColumnModified(CultureTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(CultureTableMap::COL_GUESS)) {
            $modifiedColumns[':p' . $index++]  = '`guess`';
        }

        $sql = sprintf(
            'INSERT INTO `culture` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`name`':
                        ...
                        break;
                    case '`guess`':
                        $stmt->bindValue($identifier, $this->guess, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = CultureTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Culture'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Culture'][$this->hashCode()] = true;
        $keys = CultureTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getCulture(),
            $keys[2] => $this->getName(),
            $keys[3] => $this->getGuess(),
        );
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CE\Model\Culture The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CultureTableMap::COL_ID)) {
            $criteria->add(CultureTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(CultureTableMap::COL_CULTURE)) {
            $criteria->add(CultureTableMap::COL_CULTURE, $this->culture);
        }
        if ($this->isColumnModified(CultureTableMap::COL_NAME)) {
            $criteria->add(CultureTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(CultureTableMap::COL_GUESS)) {
            $criteria->add(CultureTableMap::COL_GUESS, $this->guess);
        }
    ...
    {
        $criteria = ChildCultureQuery::create();
        $criteria->add(CultureTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CE\Model\Culture (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setGuess($this->getGuess());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CE\Model\Culture Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildCulture is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildCulture The current object (for fluent API support)
     */
    public function setWebsiteCultures(Collection $websiteCultures, ConnectionInterface $con = null)
    {
        ...
        foreach ($websiteCulturesToDelete as $websiteCultureRemoved) {
            $websiteCultureRemoved->setCulture(null);
        }
    ...
    protected function doAddWebsiteCulture(ChildWebsiteCulture $websiteCulture)
    {
        ...
        $websiteCulture->setCulture($this);
    }
    ...
    public function removeWebsiteCulture(ChildWebsiteCulture $websiteCulture)
    {
        if ($this->getWebsiteCultures()->contains($websiteCulture)) {
            ...
            $websiteCulture->setCulture(null);
        }
     ...
     * @return ObjectCollection|ChildWebsiteCulture[] List of ChildWebsiteCulture objects
     */
    public function getWebsiteCulturesJoinWebsite(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildWebsiteCultureQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(CultureTableMap::DEFAULT_STRING_FORMAT);
    }
