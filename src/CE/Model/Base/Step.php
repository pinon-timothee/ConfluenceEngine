 ...
 */
abstract class Step implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CE\\Model\\Map\\StepTableMap';
    ...
    /**
     * Initializes internal state of CE\Model\Base\Step object.
     */
    ...
    /**
     * Compares this with another <code>Step</code> instance.  If
     * <code>obj</code> is an instance of <code>Step</code>, delegates to
     * <code>equals(Step)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Step The current object, for fluid interface
     */
     ...
     * @return $this|\CE\Model\Step The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[StepTableMap::COL_ID] = true;
        }
    ...
    public function setStep($v)
    {
        ...
        if ($this->step !== $v) {
            $this->step = $v;
            $this->modifiedColumns[StepTableMap::COL_STEP] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : StepTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : StepTableMap::translateFieldName('Step', TableMap::TYPE_PHPNAME, $indexType)];
            $this->step = (null !== $col) ? (string) $col : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = StepTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CE\\Model\\Step'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildStepQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildStepQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                StepTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->websitesScheduledForDeletion !== null) {
                if (!$this->websitesScheduledForDeletion->isEmpty()) {
                    \CE\Model\WebsiteQuery::create()
                        ->filterByPrimaryKeys($this->websitesScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(StepTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(StepTableMap::COL_STEP)) {
    ...
    {
        $pos = StepTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Step'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Step'][$this->hashCode()] = true;
        $keys = StepTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getStep(),
        );
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CE\Model\Step The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(StepTableMap::DATABASE_NAME);

        if ($this->isColumnModified(StepTableMap::COL_ID)) {
            $criteria->add(StepTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(StepTableMap::COL_STEP)) {
            $criteria->add(StepTableMap::COL_STEP, $this->step);
        }
    ...
    {
        $criteria = ChildStepQuery::create();
        $criteria->add(StepTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CE\Model\Step (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CE\Model\Step Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildStep is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildStep The current object (for fluent API support)
     */
    ...
    public function removeWebsite(ChildWebsite $website)
    {
        if ($this->getWebsites()->contains($website)) {
            ...
            $this->websitesScheduledForDeletion[]= clone $website;
            $website->setStep(null);
        }
     ...
     * Otherwise if this Step is new, it will return
     * an empty collection; or if this Step has previously
     * been saved, it will retrieve related Websites from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Step.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildWebsite[] List of ChildWebsite objects
     */
    public function getWebsitesJoinAccount(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildWebsiteQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(StepTableMap::DEFAULT_STRING_FORMAT);
    }
