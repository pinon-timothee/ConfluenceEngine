 ...
 */
abstract class Meta implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CE\\Model\\Map\\MetaTableMap';
    ...
    /**
     * Initializes internal state of CE\Model\Base\Meta object.
     */
    ...
    /**
     * Compares this with another <code>Meta</code> instance.  If
     * <code>obj</code> is an instance of <code>Meta</code>, delegates to
     * <code>equals(Meta)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Meta The current object, for fluid interface
     */
     ...
     * @return $this|\CE\Model\Meta The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[MetaTableMap::COL_ID] = true;
        }
    ...
    public function setWebsiteId($v)
    {
        ...
        if ($this->website_id !== $v) {
            $this->website_id = $v;
            $this->modifiedColumns[MetaTableMap::COL_WEBSITE_ID] = true;
        }
    ...
    public function setWebsiteRoutingId($v)
    {
        ...
        if ($this->website_routing_id !== $v) {
            ...
            $this->modifiedColumns[MetaTableMap::COL_WEBSITE_ROUTING_ID] = true;
        }
    ...
    public function setCulture($v)
    {
        ...
        if ($this->culture !== $v) {
            $this->culture = $v;
            $this->modifiedColumns[MetaTableMap::COL_CULTURE] = true;
        }
    ...
    public function setHtml($v)
    {
        ...
        if ($this->html !== $v) {
            $this->html = $v;
            $this->modifiedColumns[MetaTableMap::COL_HTML] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : MetaTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : MetaTableMap::translateFieldName('WebsiteId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->website_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : MetaTableMap::translateFieldName('WebsiteRoutingId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->website_routing_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : MetaTableMap::translateFieldName('Culture', TableMap::TYPE_PHPNAME, $indexType)];
            $this->culture = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : MetaTableMap::translateFieldName('Html', TableMap::TYPE_PHPNAME, $indexType)];
            $this->html = (null !== $col) ? (string) $col : null;
            $this->resetModified();
            ...
            return $startcol + 5; // 5 = MetaTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CE\\Model\\Meta'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildMetaQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildMetaQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                MetaTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(MetaTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(MetaTableMap::COL_WEBSITE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`website_id`';
        }
        if ($this->isColumnModified(MetaTableMap::COL_WEBSITE_ROUTING_ID)) {
            $modifiedColumns[':p' . $index++]  = '`website_routing_id`';
        }
        if ($this->isColumnModified(MetaTableMap::COL_CULTURE)) {
            $modifiedColumns[':p' . $index++]  = '`culture`';
        }
        if ($this->isColumnModified(MetaTableMap::COL_HTML)) {
    ...
    {
        $pos = MetaTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Meta'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Meta'][$this->hashCode()] = true;
        $keys = MetaTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\CE\Model\Meta The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MetaTableMap::COL_ID)) {
            $criteria->add(MetaTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(MetaTableMap::COL_WEBSITE_ID)) {
            $criteria->add(MetaTableMap::COL_WEBSITE_ID, $this->website_id);
        }
        if ($this->isColumnModified(MetaTableMap::COL_WEBSITE_ROUTING_ID)) {
            $criteria->add(MetaTableMap::COL_WEBSITE_ROUTING_ID, $this->website_routing_id);
        }
        if ($this->isColumnModified(MetaTableMap::COL_CULTURE)) {
            $criteria->add(MetaTableMap::COL_CULTURE, $this->culture);
        }
        if ($this->isColumnModified(MetaTableMap::COL_HTML)) {
            $criteria->add(MetaTableMap::COL_HTML, $this->html);
        }
    ...
    {
        $criteria = ChildMetaQuery::create();
        $criteria->add(MetaTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CE\Model\Meta (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CE\Model\Meta Clone of current object.
     * @throws PropelException
     */
    ...
    public function getWebsiteRouting(ConnectionInterface $con = null)
    {
        if ($this->aWebsiteRouting === null && ($this->website_routing_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aWebsiteRouting->addMetas($this);
             */
        }
    ...
    {
        if (null !== $this->aWebsite) {
            $this->aWebsite->removeMeta($this);
        }
        if (null !== $this->aWebsiteRouting) {
            $this->aWebsiteRouting->removeMeta($this);
        }
        $this->id = null;
    ...
    {
        return (string) $this->exportTo(MetaTableMap::DEFAULT_STRING_FORMAT);
    }
