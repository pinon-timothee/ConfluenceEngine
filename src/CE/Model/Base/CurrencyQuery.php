...
use \Exception;
use \PDO;
use CE\Model\Currency as ChildCurrency;
use CE\Model\CurrencyQuery as ChildCurrencyQuery;
use CE\Model\Map\CurrencyTableMap;
 ...
 * @method     ChildCurrencyQuery orderByCountries($order = Criteria::ASC) Order by the countries column
 *
 * @method     ChildCurrencyQuery groupById() Group by the id column
 * @method     ChildCurrencyQuery groupByCode() Group by the code column
 * @method     ChildCurrencyQuery groupByCountries() Group by the countries column
 *
 ...
 * @method     ChildCurrency findOneByCountries(string $countries) Return the first ChildCurrency filtered by the countries column *
 ...
 * @method     ChildCurrency requireOneByCountries(string $countries) Return the first ChildCurrency filtered by the countries column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildCurrency[]|ObjectCollection findByCountries(string $countries) Return ChildCurrency objects filtered by the countries column
...
abstract class CurrencyQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \CE\Model\Base\CurrencyQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\CE\\Model\\Currency', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `id`, `code`, `countries` FROM `currency` WHERE `id` = :p0';
        try {
     ...
     * $query->filterByCountries('%fooValue%', Criteria::LIKE); // WHERE countries LIKE '%fooValue%'
     * </code>
     *
    ...
    public function filterByCountries($countries = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(CurrencyTableMap::COL_COUNTRIES, $countries, $comparison);
    }
