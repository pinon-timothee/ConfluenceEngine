...
use CE\Model\Currency;
use CE\Model\CurrencyQuery;
...
class CurrencyTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.CE.Model.Map.CurrencyTableMap';
     ...
     */
    const OM_CLASS = '\\CE\\Model\\Currency';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'src.CE.Model.Currency';
     ...
     */
    const COL_COUNTRIES = 'currency.countries';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Code', 'Countries', ),
        self::TYPE_CAMELNAME     => array('id', 'code', 'countries', ),
        self::TYPE_COLNAME       => array(CurrencyTableMap::COL_ID, CurrencyTableMap::COL_CODE, CurrencyTableMap::COL_COUNTRIES, ),
        self::TYPE_FIELDNAME     => array('id', 'code', 'countries', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Code' => 1, 'Countries' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'code' => 1, 'countries' => 2, ),
        self::TYPE_COLNAME       => array(CurrencyTableMap::COL_ID => 0, CurrencyTableMap::COL_CODE => 1, CurrencyTableMap::COL_COUNTRIES => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'code' => 1, 'countries' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\CE\\Model\\Currency');
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CurrencyTableMap::COL_COUNTRIES);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \CE\Model\Currency) { // it's a model object
